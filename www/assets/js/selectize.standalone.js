...
(function (root, factory) {
	...
	Selectize.define('item_color', function(options) {
	  options = $.extend({
	    custom_selectize_class: 'custom_selectize_class',
	  }, options);
	  ...
	  this.settings.onItemAdd = (function(value, $item) {
	    ...
	    return function(value, $item) {
	      ...
	      if ( option.hasOwnProperty(options.custom_selectize_class) )
	        $item.addClass(option[options.custom_selectize_class]);
